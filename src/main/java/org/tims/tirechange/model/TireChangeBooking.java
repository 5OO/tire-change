...
public class TireChangeBooking {
    ...
    private LocalDateTime bookingTime; // booking Date and time of the tire change
    private boolean available; // Indicates if the time slot is available for booking API 2 Manchester ws; NO => it is the booked slot
